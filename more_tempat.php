			...
			<div class="content-block" id="tempat">
				<div class="container">
					<header class="block-heading cleafix">
						...
						<p>Salah satu dari tempat favorit di KRB</p>
					</header>
...
<div class="col-md-12" align="center">
    ...
    <?php if ($pages>1) { ?>
    <li>
      <a href="<?php echo'tempat-'.$r['judul'].'-'.$r['id_content'];?>&pages=<?php echo $pages - 1; ?>" aria-label="Previous">
        <span aria-hidden="true">&laquo;</span>
      </a>
    </li>
      <?php }else{ ?> <li class="disabled">
      <a href="<?php echo'tempat-'.$r['judul'].'-'.$r['id_content'];?>&pages=<?php echo $pages; ?>" aria-label="Previous">
        <span aria-hidden="true">&laquo;</span>
      </a>
    </li> <?php } ?>
    <?php 
    ...
    for ($x=1; $x<=$halaman ; $x++) {
      ...
      ?>
    <li class="<?php echo "$ini"; ?>"><a href="<?php echo'tempat-'.$r['judul'].'-'.$r['id_content'];?>&pages=<?php echo "$x"; ?>"><?php echo "$x"; ?></a></li>
   <?php  } ?>
    <li>
      <a href="<?php echo'tempat-'.$r['judul'].'-'.$r['id_content'];?>&pages=<?php echo $pages + 1; ?>" aria-label="Next">
